  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<FavouriteItem>(builder: (context, value, child){
      if(value.selectedFavourites.isEmpty){
        return  Column(
          children: [
            const Center(child:  Text('Cart is Empty',style: TextStyle(fontSize: 32,fontWeight: FontWeight.w400))),
            Lottie.asset('assets/Animation/Animation - 1727797649563 (1).json',height: height * 0.63,repeat: true),
