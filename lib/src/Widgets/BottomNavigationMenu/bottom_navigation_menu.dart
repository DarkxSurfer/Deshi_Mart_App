...
class _MyAppState extends State<BottomNavigationMenu> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        bottomNavigationBar: Consumer<FavouriteItem>(builder: (context, value, child)
          ...
          child: BottomNavigationBar(
            /// esko jab ap remove kro ge to icons oper nichy hona shore ho jai gy
              ...
              items: [
                ...
                /// Home
                 const BottomNavigationBarItem(icon: Icon(Iconsax.shop),activeIcon: Icon(Iconsax.shop_add5),label: 'Shop'),

                /// Notification
                const BottomNavigationBarItem(icon:  Icon(Icons.manage_search_outlined),activeIcon: Icon(Icons.manage_search),label: 'Explore'),
                ...
                BottomNavigationBarItem(
                  ...
                  icon: value.selectedFavourites.isEmpty
                    ...
                    children: [
                      const Icon(Icons.shopping_bag_outlined, size: 30), // Fixed Icon size
                      Positioned(
                ...
                /// Profile
                const BottomNavigationBarItem(icon: Icon(Icons.favorite_outline),activeIcon:  Icon(Icons.favorite),label: 'Favourite'),
