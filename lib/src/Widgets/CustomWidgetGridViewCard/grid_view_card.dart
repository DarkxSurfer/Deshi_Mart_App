      ...
      builder: (context, value, child) {
        return Container(
          ...
          child:  Column(
            ...
            children: [
              /// under Card Image
              Image(image:  AssetImage(product.productThumbNail),height: height *0.09,fit: BoxFit.cover),

              SizedBox(height: height * 0.01),
              /// title
              Text(product.productName,style: const TextStyle(fontSize: 17,fontWeight: FontWeight.bold)),
              const SizedBox(height: 3),
              Text(product.productDescription,style: TextStyle(fontSize: 15,color: AColors.textLight)),
